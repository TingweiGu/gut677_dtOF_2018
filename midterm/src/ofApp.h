...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        string name[27] = {"door", "door2", "shelf", "shelf2", "set1", "set2", "tv", "tv2", "shoe", "shoe2", "sofa", "sofa2", "kitchen", "kitchen2", "chair", "chair2", "desk", "desk2", "table", "table2", "coffee", "coffee2", "game", "game2", "ball", "cart", "cart2"};
